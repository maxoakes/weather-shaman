...
const inputCondition = ["snow", "pressure", "rain", "visibility", "cloud cover", "wind", "temperature", "weather", "pop"];
const inputLocation = [
    { "business-name": "", "city": "Washington", "shortcut": "", "country": "", "admin-area": "", "zip-code": "", "street-address": "", "subadmin-area": "", "island": "" },
    { "shortcut": "", "island": "", "street-address": "", "city": "Mora", "business-name": "", "zip-code": "", "admin-area": "", "subadmin-area": "", "country": "" },
    { "country": "South Africa", "zip-code": "", "admin-area": "", "shortcut": "", "street-address": "", "business-name": "", "subadmin-area": "", "island": "", "city": "Cape Town" },
    { "admin-area": "", "subadmin-area": "", "island": "", "city": "London", "business-name": "", "street-address": "", "shortcut": "", "country": "United Kingdom", "zip-code": "" }, //London, UK
    { "street-address": "", "country": "", "business-name": "", "city": "", "admin-area": "", "shortcut": "", "zip-code": "40741", "subadmin-area": "", "island": "" }, //London, KY
    { "subadmin-area": "", "country": "", "business-name": "", "admin-area": "Kentucky", "city": "London", "street-address": "", "shortcut": "", "island": "", "zip-code": "" }, //London, KY
    { "business-name": "", "city": "London", "zip-code": "", "street-address": "", "island": "", "country": "", "admin-area": "Ontario", "shortcut": "", "subadmin-area": "" }, //London, ON
    { "city": "London", "country": "", "shortcut": "", "street-address": "", "island": "", "subadmin-area": "", "admin-area": "Ohio", "business-name": "", "zip-code": "" } //London, OH
];
const inputDateTime = [
    undefined,
    { date_time: "2022-05-30T12:20:00-07:00" },
    { date_time: "2022-05-22T18:30:00-07:00" },
    { date_time: "2022-05-24T12:00:00-07:00" },
    { date_time: "2022-05-23T16:00:00-07:00" },
    { date_time: "2022-05-31T17:00:00-07:00" }
    
];
const days = [0,1,2,3,4,5,6, undefined];
const limits = ["high", "low"];

test();
async function test()
{
    console.log(await getWeatherFromParameters(inputCondition[2], inputLocation[0], inputDateTime[0]));
    //console.log(`${await getForecastLimit(inputLocation[0], inputCondition[2], limits[0], days[4])}`);
    return;
    let e = inputLocation.length;
    for (let i = 0; i < e; i++)
    {
        console.log(`${i} ${await getWeatherFromParameters(inputCondition[8], inputLocation[i], inputDateTime[1])}`);
        console.log(`${i} ${await getForecast(inputLocation[i], days[7])}`);
        console.log(`${i} ${await getForecastLimit(inputLocation[i], inputCondition[8], limits[0])}`);
    }
}
